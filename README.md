...
Crea un usuario demo y 7 casos de tutela de distintos tipos y estados.

```
Email:      demo@tutelaia.co
Contraseña: demo1234
```

---

Desarrollado por **Juan Ramírez** — Pasantía Lawyers Solutions · 2025
